...
class EditorMapRenderer < MapRenderer
  ...
  protected def initialize_content
    ...
    @border_renderer = Renderer::Border.new
    @overlay_grid_renderer = Renderer::Grid.new texture: textures['ui/map_editor_overlay_grid']
    @underlay_grid_renderer = Renderer::Grid.new texture: textures['ui/map_editor_underlay_grid']
